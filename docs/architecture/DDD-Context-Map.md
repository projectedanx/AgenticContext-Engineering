...
| **QED Epistemic Context**    | Core Domain | Manages the Minimal Explainability Metadata Schema (MEMS) ingestion and Epistemic Escrow halt logic. |
...
### QED Epistemic Context ➔ Agent Definition Context

- **Relationship**: Customer-Supplier
- **Integration Pattern**: Semantic Firewall (Proxy)
- **Contract**: The Agent Definition Context queries the QED Context. The QED Context applies Topological Data Analysis (TDA) and may sever the connection (Epistemic Escrow) if the Semantic Drift Score (SDS) exceeds 0.05.
